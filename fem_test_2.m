...
outside_b = unique([e(1,dom_bound),e(2,dom_bound)]);
inside_b = unique([e(1,e(6,:)==0),e(2,e(6,:)==0)]);
% ib = unique(e(5,e(5,:)==1));
...
for sub_domain = 1:n_dom
    ...
    for k = 1:length(id)
        ...
        A(i1, i1) = A(i1, i1) + a(id(k)) * dot(g1, g1);
        A(i2, i2) = A(i2, i2) + a(id(k)) * dot(g2, g2);
        A(i3, i3) = A(i3, i3) + a(id(k)) * dot(g3, g3);
        A(i1, i2) = A(i1, i2) + a(id(k)) * dot(g1, g2);
        A(i1, i3) = A(i1, i3) + a(id(k)) * dot(g1, g3);
        A(i2, i1) = A(i2, i1) + a(id(k)) * dot(g2, g1);
        A(i2, i3) = A(i2, i3) + a(id(k)) * dot(g2, g3);
        A(i3, i1) = A(i3, i1) + a(id(k)) * dot(g3, g1);
        A(i3, i2) = A(i3, i2) + a(id(k)) * dot(g3, g2);
